...
--- @param subscribe fun(observer: rx.Observer): rx.Subscription The subscription function that produces values.
...
--- Not original RxLua
--- Creates an observable from a subject
--- @param subject rx.Subject
function Observable.fromSubject(subject)
	return Observable.create(function(observer)
